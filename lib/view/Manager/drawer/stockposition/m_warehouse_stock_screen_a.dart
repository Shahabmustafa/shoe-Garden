...
class MWarehouseStockScreen extends StatefulWidget {
  const MWarehouseStockScreen({super.key});

  @override
  State<MWarehouseStockScreen> createState() => _MWarehouseStockScreenState();
}

class _MWarehouseStockScreenState extends State<MWarehouseStockScreen> {
