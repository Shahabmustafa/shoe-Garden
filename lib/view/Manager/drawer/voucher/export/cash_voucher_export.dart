...
import '../../../../../viewmodel/admin/voucher/cash_voucher_viewmodel.dart';
import '../../../../../viewmodel/user_preference/session_controller.dart';

class CashVoucherExport {
...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0;
        i < controller.cashList.value.body!.cashVouchers!.length;
        i++) {
      final payment = controller.cashList.value.body!.cashVouchers![i];
      rows.add([
        "${i + 1}",
        (payment.customer != null ? payment.customer!.name.toString() : 'Null'),
