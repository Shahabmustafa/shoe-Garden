...
class MBarcodeScreen extends StatefulWidget {
  const MBarcodeScreen({super.key});

  @override
  State<MBarcodeScreen> createState() => _MBarcodeScreenState();
}

class _MBarcodeScreenState extends State<MBarcodeScreen> {
  @override
