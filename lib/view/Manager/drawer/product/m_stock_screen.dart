...
import '../../../Admin/drawer/product/widget/stock_inventory_table.dart';

class MStockInventoryScreen extends StatefulWidget {
  const MStockInventoryScreen({super.key});

  @override
  State<MStockInventoryScreen> createState() => _MStockInventoryScreenState();
}

class _MStockInventoryScreenState extends State<MStockInventoryScreen> {
