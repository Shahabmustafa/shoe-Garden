...
class MColorScreen extends StatefulWidget {
  const MColorScreen({super.key});

  @override
  State<MColorScreen> createState() => _MColorScreenState();
}

class _MColorScreenState extends State<MColorScreen> {
