...
class MBranchWiseDiscountScreen extends StatefulWidget {
  const MBranchWiseDiscountScreen({super.key});

  @override
  State<MBranchWiseDiscountScreen> createState() =>
      _MBranchWiseDiscountScreenState();
}

class _MBranchWiseDiscountScreenState extends State<MBranchWiseDiscountScreen> {
