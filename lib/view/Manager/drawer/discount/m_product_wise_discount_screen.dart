...
class MProductWiseDiscountScreen extends StatefulWidget {
  const MProductWiseDiscountScreen({super.key});

  @override
  State<MProductWiseDiscountScreen> createState() =>
      _MProductWiseDiscountScreenState();
}

class _MProductWiseDiscountScreenState
    extends State<MProductWiseDiscountScreen> {
