...
import '../../../Admin/drawer/bank/widget/bank_head_table.dart';

class MBankHeadScreen extends StatefulWidget {
  const MBankHeadScreen({super.key});

  @override
  State<MBankHeadScreen> createState() => _MBankHeadScreenState();
}

class _MBankHeadScreenState extends State<MBankHeadScreen> {
