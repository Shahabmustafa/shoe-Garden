...
class MBankEntryScreen extends StatefulWidget {
  const MBankEntryScreen({super.key});

  @override
  State<MBankEntryScreen> createState() => _MBankEntryScreenState();
}

class _MBankEntryScreenState extends State<MBankEntryScreen> {
