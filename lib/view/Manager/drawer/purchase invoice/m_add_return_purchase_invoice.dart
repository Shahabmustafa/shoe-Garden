...
import 'package:sofi_shoes/res/slidebar/side_menu_manager.dart';
...
class MAddReturnPurchase extends StatefulWidget {
  const MAddReturnPurchase({
    required this.uid,
    required this.user,
  ...
  @override
  State<MAddReturnPurchase> createState() => _MAddReturnPurchaseState();
}

class _MAddReturnPurchaseState extends State<MAddReturnPurchase> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: !isDesktop
          ? const SizedBox(width: 250, child: SideMenuWidgetManager())
          : null,
      body: Row(
        children: [
          isDesktop
