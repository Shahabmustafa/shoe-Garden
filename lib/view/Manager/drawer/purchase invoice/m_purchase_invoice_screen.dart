...
class MPurchaseInvoiceScreen extends StatefulWidget {
  const MPurchaseInvoiceScreen({super.key});

  @override
  State<MPurchaseInvoiceScreen> createState() => _MPurchaseInvoiceScreenState();
}

class _MPurchaseInvoiceScreenState extends State<MPurchaseInvoiceScreen> {
                    ...
                    Obx(
                      () => Expanded(
                        child: SizedBox(
                          ...
                          child: AppTextField(
                            controller:
                                widget.controller.barCodeController.value,
                            labelText: "Bar Code",
                            enabled: true,
