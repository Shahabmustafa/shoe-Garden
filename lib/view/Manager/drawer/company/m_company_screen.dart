...
import '../../../Admin/drawer/company/widget/company_table.dart';
import '../../../Admin/drawer/customer/widget/view_customer.dart';

class MCompanyScreen extends StatefulWidget {
  const MCompanyScreen({super.key});

  @override
  State<MCompanyScreen> createState() => _MCompanyScreenState();
}

class _MCompanyScreenState extends State<MCompanyScreen> {
