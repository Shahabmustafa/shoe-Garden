...
import '../../../../../viewmodel/admin/assignstock/assignstock_warehouse_viewmodel.dart';
import '../../../../../viewmodel/user_preference/session_controller.dart';

class AsignStockToWarehouseExport {
  final controller = Get.put(AssignStockWarehouseViewModel());
...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0;
        i <
            controller
                .assignStockWaresHouseList.value.body!.warehouseStocks!.length;
        i++) {
      final stock =
          controller.assignStockWaresHouseList.value.body!.warehouseStocks![i];
      rows.add([
        "${i + 1}",
