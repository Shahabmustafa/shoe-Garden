...
import '../../../Admin/drawer/expense/widget/expense_detail_table.dart';

class MExpenseDetailScreen extends StatefulWidget {
  const MExpenseDetailScreen({super.key});

  @override
  State<MExpenseDetailScreen> createState() => _MExpenseDetailScreenState();
}

class _MExpenseDetailScreenState extends State<MExpenseDetailScreen> {
