...
import '../../../../../viewmodel/admin/claim/returned_stock_branch_view_model.dart';
import '../../../../../viewmodel/user_preference/session_controller.dart';

class ReturnedStockBranchExport {
...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0;
        i <
            controller
                .returnedStockBranchList.value.body!.returnProducts!.length;
        i++) {
      final stock =
          controller.returnedStockBranchList.value.body!.returnProducts![i];
      rows.add([
        "${i + 1}",
