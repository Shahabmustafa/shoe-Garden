...
class MReturnedStockWarehouseScreen extends StatefulWidget {
  const MReturnedStockWarehouseScreen({super.key});

  @override
  State<MReturnedStockWarehouseScreen> createState() =>
      _MReturnedStockWarehouseScreenState();
}

class _MReturnedStockWarehouseScreenState
    extends State<MReturnedStockWarehouseScreen> {
