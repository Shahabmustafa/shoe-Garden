...
class SetSaleExport {
  final controller = Get.put(SetSaleViewModel());
...
// Footer widget for session information (SessionController number and name)
    ...
    final List<pw.Widget> headers = ['#', 'Date', 'Set Sale %']
    ...
    rows.add([
      "${1}",
      (controller.setSaleList.value.body!.commission!.commissionPercentage
          .toString()),
      (controller.setSaleList.value.body!.commission!.date.toString()),
    ]);
