...
class MSetSaleScreen extends StatefulWidget {
  const MSetSaleScreen({super.key});

  @override
  State<MSetSaleScreen> createState() => _MSetSaleScreenState();
}

class _MSetSaleScreenState extends State<MSetSaleScreen> {
  @override
