...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0;
        i < controller.paymentVoList.value.body!.paymentVouchers!.length;
        i++) {
      final payment = controller.paymentVoList.value.body!.paymentVouchers![i];
      rows.add([
        "${i + 1}",
