...
class APaymentVoucherScreen extends StatefulWidget {
  const APaymentVoucherScreen({super.key});

  @override
  State<APaymentVoucherScreen> createState() => _APaymentVoucherScreenState();
}

class _APaymentVoucherScreenState extends State<APaymentVoucherScreen> {
                  ...
                  case Status.COMPLETE:
                    var filteredStocks = controller.paymentVoList.value.body!.paymentVouchers!.where((data) {
                      return controller.searchValue.value.isEmpty ||
                          (data.company != null && data.company!.id.toString().toLowerCase().contains(controller.searchValue.value.trim().toLowerCase()));
                    }).toList();
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: AppExportButton(
                                    icons: Icons.add,
                                    onTap: () => PaymentVoucherExport().printPdf(),
                                  ),
                                ),
                              ],
                            ),
