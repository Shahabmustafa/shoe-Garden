...
class ACashVoucherScreen extends StatefulWidget {
  const ACashVoucherScreen({super.key});

  @override
  State<ACashVoucherScreen> createState() => _ACashVoucherScreenState();
}

class _ACashVoucherScreenState extends State<ACashVoucherScreen> {
  final CashVoucherViewModel controller = Get.put(CashVoucherViewModel());
                ...
                case Status.COMPLETE:
                  var filteredStocks = controller.cashList.value.body!.cashVouchers!.where((data) {
                    return controller.searchValue.value.isEmpty ||
                        (data.customer != null && data.customer!.id.toString().toLowerCase().contains(controller.searchValue.value.trim().toLowerCase()));
                  }).toList();
                                  ...
                                  return AppDropDown(
                                    ...
                                    onChanged: (selectedCustomerName) {
                                      ...
                                      if (selectedCustomer != null) {
                                        controller.searchValue.value = selectedCustomer['id'].toString();
                                        setState(() {
                        ...
                        Expanded(
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (controller.searchValue.value.isEmpty || name.toString().toLowerCase().contains(controller.searchValue.value.toLowerCase())) {
