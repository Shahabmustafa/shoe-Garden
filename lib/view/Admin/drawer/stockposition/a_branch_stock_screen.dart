...
class ABranchStockScreen extends StatefulWidget {
  const ABranchStockScreen({super.key});

  @override
  State<ABranchStockScreen> createState() => _ABranchStockScreenState();
}

class _ABranchStockScreenState extends State<ABranchStockScreen> {
