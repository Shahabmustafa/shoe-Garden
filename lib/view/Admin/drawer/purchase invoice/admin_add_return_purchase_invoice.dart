...
class AdminAddReturnPurchase extends StatefulWidget {
  const AdminAddReturnPurchase({
    required this.uid,
    required this.user,
  ...
  @override
  State<AdminAddReturnPurchase> createState() => _AdminAddReturnPurchaseState();
}

class _AdminAddReturnPurchaseState extends State<AdminAddReturnPurchase> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: !isDesktop
          ? const SizedBox(width: 250, child: SideMenuWidgetAdmin())
          : null,
      body: Row(
        children: [
          isDesktop
