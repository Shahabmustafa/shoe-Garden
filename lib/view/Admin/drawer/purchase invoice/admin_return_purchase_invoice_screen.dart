...
import 'admin_add_return_purchase_invoice.dart';

class AdminReturnPuchaseInvoiceScreen extends StatefulWidget {
  const AdminReturnPuchaseInvoiceScreen({super.key});

  @override
  State<AdminReturnPuchaseInvoiceScreen> createState() =>
      _AdminReturnPuchaseInvoiceScreenState();
}

class _AdminReturnPuchaseInvoiceScreenState
    extends State<AdminReturnPuchaseInvoiceScreen> {
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ListView.builder(
                            itemCount: controller.purchaseInvoiceList.value.body!.purchaseInvoices!.length,
                            itemBuilder: (context, index) {
                              final invoice = controller.purchaseInvoiceList.value.body!.purchaseInvoices![index];
                              ...
                              final invoiceData = InvoiceExport(
                                ...
                                paymentMethod: "",
                                date: DateTime.now(), // It seems you want to use the current date instead of `invoice.createdAt`
                                saleman: Salesman(name: invoice.user?.name ?? "null"),
                                customer: Customer(name: invoice.company != null ? invoice.company!.name : ""),
                                ...
                                items: invoice.invoiceProducts?.map((product) {
                                  return InvoiceItem(
                                    ...
                                    qty: int.tryParse(product.quantity?.toString() ?? '0') ?? 0,
                                    dis: product.discount != null ? "${product.discount}%" : "Null",
                                    subTotal: product.subTotal?.toString() ?? "0",
                                    totalAmount: product.totalAmount?.toString() ?? '0',
                                  );
                                }).toList() ?? [],
                              );
                              if (controller.search.value.text.isEmpty || invoice.invoiceNumber!.toString().toLowerCase().contains(controller.search.value.text.trim().toLowerCase()) || invoiceData.customer!.name.toString().toLowerCase().contains(controller.search.value.text.trim().toLowerCase())) {
                                return Column(
                                        ...
                                        children: [
                                          TableRow(
                                            ...
                                            children: [
                                              ...
                                              CustomTableCell(
                                                text: invoice.company != null ? invoice.company!.name.toString() : "Null",
                                                textColor: Colors.black,
                                              ),
                                              CustomTableCell(
                                                text: invoice.user != null ? invoice.user!.name.toString() : "Null",
                                                textColor: Colors.black,
                                              ),
                                              CustomTableCell(
                                                          ...
                                                          children: [
                                                            ...
                                                            Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  invoice.company != null ? "Company: ${invoice.company!.name.toString()}" : "Null",
                                                                  style: GoogleFonts.lato(
                                                                    fontWeight: FontWeight.w600,
                                                                    fontSize: 14,
                                                                  ),
                                                          ...
                                                          children: [
                                                            SingleChildScrollView(
                                                              ...
                                                              child: DataTable(
                                                                ...
                                                                invoice.invoiceProducts!.map((product) {return DataRow(
                                                                  cells: [
                                                                    ...
                                                                    DataCell(Text(product.product != null && product.product!.purchasePrice != null ? product.product!.purchasePrice.toString() : "Null")),
                                                                    DataCell(Text(product.product != null && product.product!.salePrice != null ? product.product!.salePrice.toString() : "Null")),
                                                            ...
                                                            /// return product
                                                            Obx(() => controllerR.returnSpecific.value.body?.purchaseReturn == null || controllerR.returnSpecific.value.body!.purchaseReturn!.isEmpty ?
                                                            const SizedBox() :
                                                            SingleChildScrollView(
                                                              scrollDirection: Axis.horizontal,
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      DataTable(
                                                                        columns: [
                                                                          DataColumn(label: Text('Product',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),)),
                                                                          DataColumn(label: Text('Color',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),)),
                                                                          DataColumn(label: Text('Size',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),)),
                                                                          DataColumn(label: Text('Quantity',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),), numeric: true,),
                                                                          DataColumn(label: Text('Purchase Price',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),), numeric: true,),
                                                                          DataColumn(label: Text('Sale Price',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),), numeric: true,),
                                                                          DataColumn(label: Text('Sub Total',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),), numeric: true,),
                                                                          DataColumn(label: Text('Discount',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),), numeric: true,),
                                                                          DataColumn(label: Text('Total Amount',style: GoogleFonts.lato(fontWeight: FontWeight.bold,fontSize: 14,),), numeric: true,),
                                                                        ],
                                                                        rows: controllerR.returnSpecific.value.body!.purchaseReturn!.expand((product) {
