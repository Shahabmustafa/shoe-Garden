...
import '../../../../../viewmodel/admin/product/brand_viewmodel.dart';
...
class BrandExport {
  ...
  Future<Uint8List> generatePdf() async {
    ...
    for (int i = 0; i < controller.brandList.value.body!.brands!.length; i++) {
      final brand = controller.brandList.value.body!.brands![i];
      rows.add([
        "${i + 1}",
        (brand.name ?? 'Null'),
      ]);
