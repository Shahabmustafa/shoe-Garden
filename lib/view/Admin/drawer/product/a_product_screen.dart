...
class AProductScreen extends StatefulWidget {
  const AProductScreen({super.key});

  @override
  State<AProductScreen> createState() => _AProductScreenState();
}

class _AProductScreenState extends State<AProductScreen> {
