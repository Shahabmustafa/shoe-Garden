...
class ASizeScreen extends StatefulWidget {
  const ASizeScreen({super.key});

  @override
  State<ASizeScreen> createState() => _ASizeScreenState();
}

class _ASizeScreenState extends State<ASizeScreen> {
