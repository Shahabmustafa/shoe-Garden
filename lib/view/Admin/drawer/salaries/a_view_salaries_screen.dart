...
class ASalariesScreen extends StatefulWidget {
  const ASalariesScreen({super.key});

  @override
  State<ASalariesScreen> createState() => _ASalariesScreenState();
}

class _ASalariesScreenState extends State<ASalariesScreen> {
