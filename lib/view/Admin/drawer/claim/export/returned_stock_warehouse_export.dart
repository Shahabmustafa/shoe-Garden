...
import '../../../../../viewmodel/admin/claim/returned_stock_warehouse_view_model.dart';
import '../../../../../viewmodel/user_preference/session_controller.dart';

class ReturnedStockWarehouseExport {
  ...
  Future<Uint8List> generatePdf() async {
    ...
    final subTitle = pw.Align(
        alignment: pw.Alignment.topCenter,
        child: pw.Text(
          'Returned Stock Warehouse Report',
          textAlign: pw.TextAlign.center,
          style: pw.TextStyle(
            fontSize: 18,
            fontWeight: pw.FontWeight.bold,
...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0;
        i <
            controller
                .returnedStockWarehouseList.value.body!.returnProducts!.length;
        i++) {
      final stock =
          controller.returnedStockWarehouseList.value.body!.returnProducts![i];
      rows.add([
        "${i + 1}",
