...
class AReturnedStockBranchScreen extends StatefulWidget {
  const AReturnedStockBranchScreen({super.key});

  @override
  State<AReturnedStockBranchScreen> createState() =>
      _AReturnedStockBranchScreenState();
}

class _AReturnedStockBranchScreenState
    extends State<AReturnedStockBranchScreen> {
