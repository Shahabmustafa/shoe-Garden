...
class AWarehouseClaimScreen extends StatefulWidget {
  const AWarehouseClaimScreen({super.key});

  @override
  State<AWarehouseClaimScreen> createState() => _AWarehouseClaimScreenState();
}

class _AWarehouseClaimScreenState extends State<AWarehouseClaimScreen> {
                                  ...
                                  children: [
                                    TableRow(
                                      ...
                                      children: [
                                        ...
                                        CustomTableCell(
                                          text: warehouseClaim.quantity.toString() ?? "null",
                                          textColor: Colors.black,
                                        ),
                                        CustomTableCell(
                                          text: warehouseClaim.description.toString() ?? "null",
                                          textColor: Colors.black,
                                        ),
                                        TableCell(
