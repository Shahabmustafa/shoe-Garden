...
import 'package:sofi_shoes/view/Admin/drawer/claim/export/returned_stock_warehouse_export.dart';
import 'package:sofi_shoes/view/Manager/drawer/dashboard/dashboard_screen_a.dart';
import 'package:sofi_shoes/viewmodel/admin/claim/returned_stock_warehouse_view_model.dart';
...
class AReturnedStockWarehouseScreen extends StatefulWidget {
  const AReturnedStockWarehouseScreen({super.key});

  @override
  State<AReturnedStockWarehouseScreen> createState() =>
      _AReturnedStockWarehouseScreenState();
}

class _AReturnedStockWarehouseScreenState
    extends State<AReturnedStockWarehouseScreen> {
  Future<void> refresh() async {
    Get.put(ReturnedStockWarehouseViewModel()).refreshApi();
  }

  Widget build(BuildContext context) {
    final isDesktop = Responsive.isDesktop(context);
    final size = MediaQuery.sizeOf(context);
    final controller = Get.put(ReturnedStockWarehouseViewModel());
    return Scaffold(
      appBar: AppBar(
        title: const Text("Returned Stock From Warehouse"),
      ),
                      ...
                      children: [
                        ...
                        Flexible(
                          child: AppExportButton(
                            icons: Icons.add,
                            onTap: () =>
                                ReturnedStockWarehouseExport().printPdf(),
                          ),
                        ),
                      ],
                    ),
                  ...
                  Expanded(child: Obx(() {
                    switch (controller.rxRequestStatus.value) {
                      ...
                      case Status.COMPLETE:
                        var filteredStocks = controller.returnedStockWarehouseList.value.body!.returnProducts!.where((data) {
                        ...
                        ListView.builder(
                          itemCount: controller.returnedStockWarehouseList.value.body!.returnProducts!.length,
                          itemBuilder: (context, index) {
                            var stock = controller.returnedStockWarehouseList.value.body!.returnProducts![index];
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              showDialog(
                                                ...
                                                builder: (context) {
                                                  return ViewClaim(
                                                    title: "Return Stock To Warehouse Detail",
