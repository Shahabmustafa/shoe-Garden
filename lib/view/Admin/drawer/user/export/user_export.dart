...
import '../../../../../viewmodel/admin/user/user_viewmodel.dart';
...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0; i < controller.userList.value.body!.users!.length; i++) {
      final user = controller.userList.value.body!.users![i];
