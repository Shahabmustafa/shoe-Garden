...
import 'package:sofi_shoes/view/Admin/drawer/expense/widget/branch_expense_table.dart';
...
class AAllBranchExpensesScreen extends StatefulWidget {
  const AAllBranchExpensesScreen({super.key});

  @override
  State<AAllBranchExpensesScreen> createState() =>
      _AAllBranchExpensesScreenState();
}

class _AAllBranchExpensesScreenState extends State<AAllBranchExpensesScreen> {
