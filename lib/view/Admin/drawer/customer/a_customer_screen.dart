...
import 'package:sofi_shoes/view/Admin/drawer/customer/widget/view_customer.dart';
...
class ACustomerScreen extends StatefulWidget {
  const ACustomerScreen({super.key});

  @override
  State<ACustomerScreen> createState() => _ACustomerScreenState();
}

class _ACustomerScreenState extends State<ACustomerScreen> {
