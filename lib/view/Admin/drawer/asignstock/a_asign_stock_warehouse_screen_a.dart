...
class AAssignStockToWarehouseScreen extends StatefulWidget {
  const AAssignStockToWarehouseScreen({super.key});

  @override
  State<AAssignStockToWarehouseScreen> createState() =>
      _AAssignStockToWarehouseScreenState();
}

class _AAssignStockToWarehouseScreenState
    extends State<AAssignStockToWarehouseScreen> {
