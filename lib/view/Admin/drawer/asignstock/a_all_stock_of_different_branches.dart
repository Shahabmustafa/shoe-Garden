...
class AApproveStockDifferentBranchScreen extends StatefulWidget {
  const AApproveStockDifferentBranchScreen({super.key});

  @override
  State<AApproveStockDifferentBranchScreen> createState() =>
      _AApproveStockDifferentBranchScreenState();
}

class _AApproveStockDifferentBranchScreenState
    extends State<AApproveStockDifferentBranchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("All Stock Different Branches"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
