...
class AAssignStockToBranchScreen extends StatefulWidget {
  const AAssignStockToBranchScreen({super.key});

  @override
  State<AAssignStockToBranchScreen> createState() =>
      _AAssignStockToBranchScreenState();
}

class _AAssignStockToBranchScreenState
    extends State<AAssignStockToBranchScreen> {
