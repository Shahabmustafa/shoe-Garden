...
import '../../../../../viewmodel/admin/assignstock/assignstock_branch_viewmodel.dart';
import '../../../../../viewmodel/user_preference/session_controller.dart';

class AsignStockToBranchExport {
  final controller = Get.put(AssignStockBranchViewModel());
...
//footer
    ...
    for (int i = 0; i < controller.assignStockBranchList.value.body!.branchStocks!.length; i++) {
      final stock = controller.assignStockBranchList.value.body!.branchStocks![i];
      rows.add([
        "${i + 1}",
