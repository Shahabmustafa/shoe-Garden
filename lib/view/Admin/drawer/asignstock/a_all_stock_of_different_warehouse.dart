...
class AApproveStockDifferentWarehouseScreen extends StatefulWidget {
  const AApproveStockDifferentWarehouseScreen({super.key});

  @override
  State<AApproveStockDifferentWarehouseScreen> createState() =>
      _AApproveStockDifferentWarehouseScreenState();
}

class _AApproveStockDifferentWarehouseScreenState
    extends State<AApproveStockDifferentWarehouseScreen> {
