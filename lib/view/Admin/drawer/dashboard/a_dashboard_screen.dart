                      ...
                      children: [
                        ...
                        Expanded(
                          child: ListView.builder(
                            itemCount: snapshot.data!.body!.mostRepeatedProducts!.length,
                            itemBuilder: (context, index) {
                              var data = snapshot.data!.body!.mostRepeatedProducts![index];
                              var number = data.count != null ? data.count!.toString() : "null";
                              var artical = data.product != null ? data.product!.name.toString() : "null";
                              var code = data.product != null ? data.product!.productCode.toString() : "null";
                              var image = data.product != null ? data.product!.image.toString() : "null";
                              var category = data.type != null ? data.type!.name.toString() : "null";
                              var company = data.company != null ? data.company!.name.toString() : "null";
                              var brand = data.brand != null ? data.brand!.name.toString() : "null";
