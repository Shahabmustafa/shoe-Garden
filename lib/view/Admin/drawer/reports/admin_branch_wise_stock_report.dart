...
import 'package:sofi_shoes/viewmodel/admin/stockposition/branch_stock_viewmodel.dart';
...
import '../../../Manager/drawer/stockposition/export/branch_stock_export.dart';

class ABranchWiseStockReport extends StatefulWidget {
  const ABranchWiseStockReport({super.key});

  @override
  State<ABranchWiseStockReport> createState() => _ABranchWiseStockReportState();
}

class _ABranchWiseStockReportState extends State<ABranchWiseStockReport> {
  Future<void> refresh() async {
    Get.put(BranchStockViewModel()).refreshApi();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Branch Wise Stock Report"),
      ),
