...
class APurchaseInvoiceReport extends StatefulWidget {
  const APurchaseInvoiceReport({super.key});

  @override
  State<APurchaseInvoiceReport> createState() => _APurchaseInvoiceReportState();
}

class _APurchaseInvoiceReportState extends State<APurchaseInvoiceReport> {
  @override
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final invoiceData = InvoiceExport(
                                paymentMethod: "",
                                id: invoice.invoiceNumber?.toString() ?? "Unknown", // Ensures id is never null
                                date: DateTime.now(), // Uses the current date
                                saleman: Salesman(name: invoice.user != null ? invoice.user!.name.toString() : "Unknown",),
                                customer: Customer(name: invoice.company != null ? invoice.company!.name : "Unknown",),
                                total: invoice.totalAmount?.toString() ?? "0", // Handles null totalAmount
                              ...
                              var name = invoice.invoiceNumber?.toString() ?? "Null";
                              var company = invoice.company != null ? invoice.company!.name : "Null";
                              if (controller.search.value.text.isEmpty || name.toLowerCase().contains(controller.search.value.text.trim().toLowerCase()) || company!.toString().toLowerCase().contains(controller.search.value.text.trim().toLowerCase())) {
                                return Column(
                                        ...
                                        children: [
                                          TableRow(
                                            ...
                                            children: [
                                              ...
                                              CustomTableCell(
                                                text: invoice.invoiceNumber?.toString() ?? "Null", // Handle null
                                                textColor: Colors.black,
                                              ),
                                              CustomTableCell(
                                                text: invoice.company != null ? invoice.company!.name : "Null", // Handle null
                                                textColor: Colors.black,
                                              ),
                                              CustomTableCell(
                                                text: invoice.user != null ? invoice.user!.name : "Null", // Handle null
                                                textColor: Colors.black,
                                              ),
                                              CustomTableCell(
                                                text: formattedDate, // Assume formattedDate is non-null
                                                textColor: Colors.black,
                                              ),
                                              GestureDetector(
                                                onTap: () {
                                                          ...
                                                          children: [
                                                            SingleChildScrollView(
                                                              ...
                                                              child: DataTable(
                                                                ...
                                                                rows: invoice.invoiceProducts?.map((product) {
                                                                  return DataRow(
                                                                    cells: [
                                                                      ...
                                                                      DataCell(Text(product.product?.purchasePrice?.toString() ?? "Null")),
                                                                ...
                                                                }).toList() ?? [], // Handle null product list
                                                              ),
                                                            ),
                                                            const SizedBox(
                                                                height: 30),
