...
import '../claim/export/returned_stock_warehouse_export.dart';

class AReturnedStockWarehouseReportScreen extends StatefulWidget {
  const AReturnedStockWarehouseReportScreen({super.key});

  @override
  State<AReturnedStockWarehouseReportScreen> createState() =>
      _AReturnedStockWarehouseReportScreenState();
}

class _AReturnedStockWarehouseReportScreenState
    extends State<AReturnedStockWarehouseReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Returned Stock From Warehouse Reports"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
