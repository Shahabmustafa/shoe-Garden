...
class AWarehouseWiseStockReport extends StatefulWidget {
  const AWarehouseWiseStockReport({super.key});

  @override
  State<AWarehouseWiseStockReport> createState() =>
      _AWarehouseWiseStockReportState();
}

class _AWarehouseWiseStockReportState extends State<AWarehouseWiseStockReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Warehouse Wise Stock Report"),
      ),
