...
import '../claim/export/branch_claim_export.dart';

class ABranchClaimReport extends StatefulWidget {
  const ABranchClaimReport({super.key});

  @override
  State<ABranchClaimReport> createState() => _ABranchClaimReportState();
}

class _ABranchClaimReportState extends State<ABranchClaimReport> {
                                                  ...
                                                  showDialog(
                                                    ...
                                                    builder: (context) {
                                                      return ViewClaim(
                                                        ...
                                                        claimForm: branchClaim.claimFrom != null ? branchClaim.claimFrom!.name.toString() : "null",
                                                        claimTO: branchClaim.claimTo != null ? branchClaim.claimTo!.name.toString() : "null",
                                                        product: branchClaim.product != null ? branchClaim.product!.name.toString() : "null",
                                                        brand: branchClaim.brand != null ? branchClaim.brand!.name.toString() : "null",
                                                        company: branchClaim.company != null ? branchClaim.company!.name.toString() : "null",
                                                        color: branchClaim.color != null ? branchClaim.color!.name.toString() : "null",
                                                        size: branchClaim.size != null ? branchClaim.size!.number.toString() : "null",
                                                        type: branchClaim.type != null ? branchClaim.type!.name.toString() : "null",
                                                        quantity: branchClaim.quantity != null ? branchClaim.quantity.toString() : "null",
                                                        date: branchClaim.date != null ? branchClaim.date.toString() : "null",
                                                        description: branchClaim.description != null ? branchClaim.description.toString() : "null",
                                                      );
                                                    },
                                                  );
                                                },
