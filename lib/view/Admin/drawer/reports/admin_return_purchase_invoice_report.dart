...
class AReturnedPurchaseInvoiceReport extends StatefulWidget {
  const AReturnedPurchaseInvoiceReport({super.key});

  @override
  State<AReturnedPurchaseInvoiceReport> createState() =>
      _AReturnedPurchaseInvoiceReportState();
}

class _AReturnedPurchaseInvoiceReportState
    extends State<AReturnedPurchaseInvoiceReport> {
