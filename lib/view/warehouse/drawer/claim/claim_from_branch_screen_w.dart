...
import 'export/claim_from__branch_export.dart';

class ClaimFromBranchScreenWarehouse extends StatefulWidget {
  const ClaimFromBranchScreenWarehouse({super.key});

  @override
  State<ClaimFromBranchScreenWarehouse> createState() =>
      _ClaimFromBranchScreenWarehouseState();
}

class _ClaimFromBranchScreenWarehouseState
    extends State<ClaimFromBranchScreenWarehouse> {
  String? selectType = 'Select Type';
  Future<void> refresh() async {
    Get.put(WClaimFromBranchViewModel()).refreshApi();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Claim From Branch"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
                      ...
                      child: Column(
                        children: [
                          ...
                          Expanded(
                            child: Builder(
                              builder: (context) {
                                // Filter the claims based on the search criteria
                                final filteredClaims = controller.claimList.value.body!.claims!
                                    .where((stock) {
                                  var name = stock.claimFrom != null ? stock.claimFrom!.name.toString() : "";
                                        ...
                                        children: [
                                          TableRow(
                                            ...
                                            children: [
                                              ...
                                              CustomTableCell(
                                                text: stock.claimFrom != null ? stock.claimFrom!.name : 'null',
                                                textColor: Colors.black,
                                              ),
                                              CustomTableCell(
