...
import '../../../../../viewmodel/warehouse/claim/claim_to_admin_viewmodel.dart';

class ClaimToAdminExport {
...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0; i < controller.claimList.value.body!.claims!.length; i++) {
      final stock = controller.claimList.value.body!.claims![i];
      rows.add([
        "${i + 1}",
