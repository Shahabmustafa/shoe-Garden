...
import 'package:sofi_shoes/viewmodel/warehouse/claim/claim_to_admin_viewmodel.dart';
...
import 'export/claim_to_admin_export.dart';

class CliamToAdminScreenWarehouse extends StatefulWidget {
  const CliamToAdminScreenWarehouse({super.key});

  @override
  State<CliamToAdminScreenWarehouse> createState() =>
      _CliamToAdminScreenWarehouseState();
}

class _CliamToAdminScreenWarehouseState
    extends State<CliamToAdminScreenWarehouse> {
  String? selectType = 'Select Type';
  Future<void> refresh() async {
    Get.put(WClaimToAdminViewModel()).refreshApi();
  }

  @override
  Widget build(BuildContext context) {
    final isDesktop = Responsive.isDesktop(context);
    final controller = Get.put(WClaimToAdminViewModel());
    return Scaffold(
      appBar: AppBar(
        title: const Text("Claim To Admin"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
      ...
      floatingActionButton: FloatingActionButton.extended(
          ...
          showDialog(
            ...
            builder: (context) {
              ...
              return StatefulBuilder(builder: (context, setState) {
                return AlertDialog(
                  title: const Text("Claim For Admin"),
                  content: Obx(
        ...
        label: const Text("Add Claims For Admin"),
      ),
    );
  }
}
