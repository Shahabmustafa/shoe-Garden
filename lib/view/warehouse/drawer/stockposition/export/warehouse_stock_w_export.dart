...
class WarehouseStockWExport {
  ...
  Future<Uint8List> generatePdf() async {
    ...
    for (int i = 0; i < controller.myWarehouseStockList.value.body!.warehouseStocks!.length; i++) {
      final stock = controller.myWarehouseStockList.value.body!.warehouseStocks![i];
      rows.add([
        "${i + 1}",
