...
import '../../../../../viewmodel/warehouse/Stock Position/branch_stock_viewmodel.dart';

class BranchStockWExport {
  final controller = Get.put(WBranchStockViewModel());
...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0;
        i < controller.branchStockList.value.body!.branchStocks!.length;
        i++) {
