...
class ReturnedStockToWarehouseExport {
...
// Footer widget for session information (SessionController number and name)
    ...
    for (int i = 0;
        i < controller.stockList.value.body!.returnProducts!.length;
        i++) {
      final stock = controller.stockList.value.body!.returnProducts![i];
      rows.add([
        "${i + 1}",
