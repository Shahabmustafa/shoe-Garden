...
import 'package:sofi_shoes/view/warehouse/drawer/Assign%20stock/export/returned_stock_to_admin_export.dart';
...
class WReturnStockAdminReportScreen extends StatefulWidget {
  const WReturnStockAdminReportScreen({super.key});

  @override
  State<WReturnStockAdminReportScreen> createState() =>
      _WReturnStockAdminReportScreenState();
}

class _WReturnStockAdminReportScreenState
    extends State<WReturnStockAdminReportScreen> {
                        ...
                        Expanded(
                          child: ListView.builder(
                            itemCount: controller
                                .stockList.value.body!.returnProducts!.length,
                            itemBuilder: (context, index) {
                              var stock = controller
                                  .stockList.value.body!.returnProducts![index];
