...
import 'package:sofi_shoes/view/warehouse/drawer/stockposition/export/warehouse_stock_w_export.dart';
...
class WStockWarehouseOtherReportScreen extends StatefulWidget {
  const WStockWarehouseOtherReportScreen({super.key});

  @override
  State<WStockWarehouseOtherReportScreen> createState() =>
      _WStockWarehouseOtherReportScreenState();
}

class _WStockWarehouseOtherReportScreenState extends State<WStockWarehouseOtherReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Stock Report Other Warehouse'),
      ),
