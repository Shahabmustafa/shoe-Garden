...
import 'package:sofi_shoes/view/warehouse/drawer/Assign%20stock/export/assign_stock_to_warehouse_export.dart';
import 'package:sofi_shoes/viewmodel/warehouse/Assign%20Stock/assign_stock_another_warehouse_viewmodel.dart';
...
class WAssignStockWarehouseReportScreen extends StatefulWidget {
  const WAssignStockWarehouseReportScreen({super.key});

  @override
  State<WAssignStockWarehouseReportScreen> createState() =>
      _WAssignStockWarehouseReportScreenState();
}

class _WAssignStockWarehouseReportScreenState
    extends State<WAssignStockWarehouseReportScreen> {
  Future<void> refresh() async {
    Get.put(WAssignStockAnotherWarehouseViewModel()).refreshApi();
  }
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              var name = assignStock.warehouse != null
                                  ? assignStock.warehouse!.name
                                  : '';
