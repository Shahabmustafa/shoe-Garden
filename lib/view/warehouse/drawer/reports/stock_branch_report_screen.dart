...
class WStockBranchReportScreen extends StatefulWidget {
  const WStockBranchReportScreen({super.key});

  @override
  State<WStockBranchReportScreen> createState() => _WStockBranchReportScreenState();
}

class _WStockBranchReportScreenState extends State<WStockBranchReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Branch Stock Report"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
        width: 250,
