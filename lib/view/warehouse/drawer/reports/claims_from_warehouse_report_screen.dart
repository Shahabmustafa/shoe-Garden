...
import '../claim/export/claim_from_warehouse_export.dart';

class WClaimsFromWarehouseScreenReport extends StatefulWidget {
  const WClaimsFromWarehouseScreenReport({super.key});

  @override
  State<WClaimsFromWarehouseScreenReport> createState() =>
      _WClaimsFromWarehouseScreenReportState();
}

class _WClaimsFromWarehouseScreenReportState
    extends State<WClaimsFromWarehouseScreenReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Claim From Warehouse Report"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
                            ...
                            children: [
                              ...
                              Flexible(
                                child: AppExportButton(
                                  icons: Icons.add,
                                  onTap: () =>
                                      ClaimFromWarehouseExport().printPdf(),
                                ),
                              ),
                            ],
                          ),
