...
import 'package:sofi_shoes/viewmodel/warehouse/report/sale_invoice_report_viewmodel.dart';
...
class WarehouseSaleInvoiceReport extends StatefulWidget {
  const WarehouseSaleInvoiceReport({super.key});

  @override
  State<WarehouseSaleInvoiceReport> createState() =>
      _WarehouseSaleInvoiceReportState();
}

class _WarehouseSaleInvoiceReportState
    extends State<WarehouseSaleInvoiceReport> {
  // String formatInvoiceNumber(int number) {
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(WarehouseSaleInvoiceReportViewModel());
    final isDesktop = Responsive.isDesktop(context);
    return Scaffold(
      appBar: AppBar(
        title: const Text("Warehouse Sale Report"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
                                        ...
                                        children: [
                                          TableRow(
                                            ...
                                            children: [
                                              ...
                                              CustomTableCell(
                                                text: invoiceData.paymentMethod ?? "Null",
                                                textColor: Colors.black,
                                              ),
                                              GestureDetector(
                                                onTap: () {
                                                            ...
                                                            children: [
                                                              Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    "Payment Method : ${invoiceData.paymentMethod ?? "Null"}",
                                                                    style:
                                                                    GoogleFonts
                                                                        .lato(
                                                                      fontWeight:
