...
import 'w_add_sale_return.dart';

class WarehouseSaleReturn extends StatefulWidget {
  const WarehouseSaleReturn({super.key});

  @override
  State<WarehouseSaleReturn> createState() => _WarehouseSaleReturnState();
}

class _WarehouseSaleReturnState extends State<WarehouseSaleReturn> {
                                                          ...
                                                          children: [
                                                            SingleChildScrollView(
                                                              ...
                                                              const SizedBox(
                                                                  ...
                                                                  ///Return product
                                                                  Obx(
                                                                    () => controllerR.specificInvoice.value.body?.saleReturn == null ?
                                                                    SizedBox() :
                                                                    Column(
                                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                                      children: [
                                              ...
                                              GestureDetector(
                                                onTap: () {
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (context) => WarehouseAddSaleReturn(
