...
class WarehouseAddSaleReturn extends StatefulWidget {
  const WarehouseAddSaleReturn({
    required this.uid,
  ...
  @override
  State<WarehouseAddSaleReturn> createState() => _WarehouseAddSaleReturnState();
}

class _WarehouseAddSaleReturnState extends State<WarehouseAddSaleReturn> {
            ...
            child: Obx(() {
              switch (returnInvoice.rxRequestStatus.value) {
                ...
                case Status.COMPLETE:
                  return returnInvoice.loading.value
                                    ...
                                    Expanded(
                                      child: ElevatedButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          returnInvoice.addReturnSaleInvoice(
                                              context, jsonString);

                                          print(
                                              'return reportssssssssssssssss');
                                          print(jsonString);
