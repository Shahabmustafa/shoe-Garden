...
class WProductScreen extends StatefulWidget {
  const WProductScreen({super.key});

  @override
  State<WProductScreen> createState() => _WProductScreenState();
}

class _WProductScreenState extends State<WProductScreen> {
                  ...
                  child: Obx(() {
                    switch (controller.rxRequestStatus.value) {
                      ...
                      // Filter products based on the search criteria
                        final filteredProducts = controller.productList.value.body!.products!
                            .where((product) {
                          return controller.search.value.text.isEmpty ||
                              product.name!.toLowerCase().contains(controller.search.value.text.trim().toLowerCase());
                        }).toList();

                        // Check if there are any filtered products
                        if (filteredProducts.isEmpty) {
                          return NotFoundWidget(title: "Not Found Article");
                        }
