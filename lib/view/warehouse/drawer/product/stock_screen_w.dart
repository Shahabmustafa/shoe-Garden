...
import '../../../../viewmodel/warehouse/barcode/barcode_view_model.dart';
import '../../../Admin/drawer/product/export/stock_export.dart';

class WStockInventoryScreen extends StatefulWidget {
  const WStockInventoryScreen({super.key});

  @override
  State<WStockInventoryScreen> createState() => _WStockInventoryScreenState();
}

class _WStockInventoryScreenState extends State<WStockInventoryScreen> {
                    ...
                    child: Obx(() {
                      switch (controller.rxRequestStatus.value) {
                        ...
                        case Status.COMPLETE:
                          final filteredProducts = controller.stockInventoryList.value.body!.productStock!
                              .where((product) {
                              ...
                              return StockInventoryTable(
                                ...
                                editOnpress: () {
                                  showDialog(
                                    ...
                                    builder: (context) {
                                      selectBarCode =
                                      stockInventory.barcode != null
                                          ? stockInventory.barcode
                                          .toString()
                                          : "Null";
                                      selectProduct =
                                      stockInventory.product != null
                                          ? stockInventory.product!.name
                                          .toString()
                                          : "Null";
                                      selectCompany =
                                      stockInventory.company != null
                                          ? stockInventory.company!.name
                                          .toString()
                                          : "null";
                                      selectBrand =
                                      stockInventory.brand != null
                                          ? stockInventory.brand!.name
                                          .toString()
                                          : "null";
                                      selectType = stockInventory.type != null
                                          ? stockInventory.type!.name
                                          .toString()
                                          : "null";
                                      selectColor =
                                      stockInventory.color != null
                                          ? stockInventory.color!.name
                                          .toString()
                                          : "null";
                                      selectSize = stockInventory.size != null
                                          ? stockInventory.size!.number
                                          .toString()
                                          : "null";

                                      controller.company.value =
                                      stockInventory.companyId != null
                                          ? stockInventory.companyId
                                          .toString()
                                          : "null";
                                      controller.brand.value =
                                      stockInventory.brandId != null
                                          ? stockInventory.brandId
                                          .toString()
                                          : "null";
                                      controller.size.value =
                                      stockInventory.sizeId != null
                                          ? stockInventory.sizeId
                                          .toString()
                                          : "null";
                                      controller.color.value =
                                      stockInventory.colorId != null
                                          ? stockInventory.colorId
                                          .toString()
                                          : "null";
                                      controller.product.value =
                                      stockInventory.productId != null
                                          ? stockInventory.productId
                                          .toString()
                                          : "null";
                                      controller.type.value =
                                      stockInventory.typeId != null
                                          ? stockInventory.typeId
                                          .toString()
                                          : "null";

                                      controller.quantity.value.text =
                                      stockInventory.quantity != null
                                              ...
                                              children: [
                                                ...
                                                AppDropDown(
                                                  ...
                                                  items: controller
                                                      ...
                                                      .toList(),
                                                  selectedItem:
                                                  selectProduct, // set the initial value
                                                ...
                                                AppDropDown(
                                                  ...
                                                  items: controller
                                                      ...
                                                      .toList(),
                                                  selectedItem:
                                                  selectCompany, // set the initial value
                                                  onChanged:
                                                      (newSelectCompany) {
                                                    var company = controller
                                                        .companyDropdownItems
                                                        .firstWhere(
                                                          (head) =>
                                                      head['name']
                                                ...
                                                AppDropDown(
                                                  ...
                                                  items: controller
                                                      ...
                                                      .toList(),
                                                  selectedItem:
                                                  selectBrand, // set the initial value
                                                  onChanged: (selectBrand) {
                                  ...
                                  showDialog(
                                      ...
                                      builder: (context) {
                                        return EditDialog(
                                          ...
                                          accept: () {
                                            controller.deleteStockInventory(
                                                stockInventory.id.toString());
                                          },
                                        );
                                      });
                                },
                        ...
                        GestureDetector(
                          ...
                          child: Obx(() {
                            ...
                            return AppTextField(
                              labelText: "Barcode",
                              enabled: false,
                              suffixIcon: Icon(Icons.generating_tokens_sharp),
