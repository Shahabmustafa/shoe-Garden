...
import 'add_exchange_product_screen.dart';
import 'export/sale_invoice_export.dart';
import 'sale_exchange_product_model.dart';

class BExchangeProductScreen extends StatefulWidget {
  const BExchangeProductScreen({super.key});

  @override
  State<BExchangeProductScreen> createState() => _BExchangeProductScreenState();
}

class _BExchangeProductScreenState extends State<BExchangeProductScreen> {
  @override
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final invoiceData = InvoiceExport(
                                ...
                                date: DateTime.now(),
                                saleman: Salesman(name: invoice.saleman != null ? invoice.saleman!.name.toString() : "Null"),
                                customer: Customer(name: invoice.customer != null ? invoice.customer!.name.toString() : "Null"),
                                total: invoice.totalAmount?.toString() ?? "Null",
                                items: invoice.invoiceProducts!.map((product) {
                                  return InvoiceItem(
                                    product: product.product?.name.toString() ?? "Null",
                                    salePrice: product.salePrice?.toString() ?? "Null",
                                    qty: int.parse(product.quantity?.toString() ?? "0"),
                                    dis: product.discount?.toString() ?? "Null",
                                    subTotal: product.subTotal?.toString() ?? 'null',
                                    totalAmount: product.totalAmount?.toString() ?? "null",
                                  );
                                }).toList(),
                              );
                                        ...
                                        children: [
                                          TableRow(
                                            ...
                                            children: [
                                              ...
                                              CustomTableCell(
                                                text: invoice.paymentMethod ?? "Null",
                                                textColor: Colors.black,
                                              ),
                                              GestureDetector(
                                                onTap: () {
                                                            ...
                                                            children: [
                                                              SingleChildScrollView(
                                                                ...
                                                                DataTable(
                                                                  ...
                                                                  rows: invoice.invoiceProducts != null ? invoice.invoiceProducts!.map((product) {
                                                                    return DataRow(
                                                                      cells: [
                                                                        ...
                                                                        DataCell(Text(product.product != null ? product.product!.salePrice.toString() : "Null")),
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    invoice.receivedAmount != null ? invoice.receivedAmount.toString() : "Null",
                                                                    style: GoogleFonts.lato(
                                                                      fontSize: 14,
                                                                      fontWeight: FontWeight.w500,
                                                                    ),
                                              ...
                                              GestureDetector(
                                                onTap: () {
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (context) => AddExchangeProductScreen(
                                                        uid: invoice.id?.toString() ?? 'null',
                                                        invoiceNo: invoice.invoiceNumber?.toString() ?? 'null',
                                                        salesmanId: invoice.saleman!.id?.toString() ?? 'null',
                                                        salesmanName: invoice.saleman!.name?.toString() ?? 'null',
                                                        customerId: invoice.customer!.id?.toString() ?? 'null',
                                                        customerName: invoice.customer!.name?.toString() ?? 'null',
                                                        receivedAmount: invoice.receivedAmount?.toString() ?? "0",
                                                        returnAmount: invoice.totalAmount?.toString() ?? "0",
