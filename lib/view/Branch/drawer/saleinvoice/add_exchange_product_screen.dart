...
class AddExchangeProductScreen extends StatefulWidget {
  const AddExchangeProductScreen({
  ...
  _AddExchangeProductScreenState createState() => _AddExchangeProductScreenState();
}

class _AddExchangeProductScreenState extends State<AddExchangeProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // var valueAdd = int.parse(controller.totalAmount.value.toString()) - int.parse(widget.receivedAmount);
    return Scaffold(
      appBar: AppBar(
                              ...
                              (i) {
                                ...
                                return DataRow(
                                  ...
                                  cells: [
                                    ...
                                    DataCell(IconButton(icon: const Icon(Icons.delete), onPressed: () {controller.deleteProduct(i);},),),
                                  ],
                                );
                              },
                            ),
                                        ...
                                        ElevatedButton(
                                          onPressed: (){
                                            Map<String, dynamic> returns = {
                                              ...
                                              "new_sale_men_id": widget.salesmanId,
