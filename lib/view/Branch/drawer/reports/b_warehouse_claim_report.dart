...
import 'package:sofi_shoes/viewmodel/branch/claim/warehouse_claim_view_model.dart';

import '../../../../res/circularindictor/circularindicator.dart';
import '../../../../res/tabletext/table_text.dart';
import '../../../Manager/drawer/dashboard/dashboard_screen_a.dart';
import '../claims/export/warehouse_claim_export.dart';
import '../claims/view_warehouse_claim.dart';

class BWarehouseClaimReport extends StatefulWidget {
  const BWarehouseClaimReport({super.key});

  @override
  State<BWarehouseClaimReport> createState() => _BWarehouseClaimReportState();
}

class _BWarehouseClaimReportState extends State<BWarehouseClaimReport> {
  Future<void> refreshCustomerList() async {
    Get.put(BWarehouseClaimViewModel()).refreshApi();
  }

  @override
  void initState() {
    super.initState();
    Get.put(BWarehouseClaimViewModel()).getAll();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.put(BWarehouseClaimViewModel());
    return Scaffold(
      appBar: AppBar(
        title: const Text("Warehouse Claim Report"),
      ),
                ...
                Expanded(child: Obx(() {
                  switch (controller.rxRequestStatus.value) {
                    ...
                    case Status.COMPLETE:
                      return controller.warehouseClaimList.value.body!.claims!.isNotEmpty ?
                      ListView.builder(
                        itemCount: controller.warehouseClaimList.value.body!.claims!.length,
                        itemBuilder: (context, index) {
                          var data = controller.warehouseClaimList.value.body!.claims![index];
