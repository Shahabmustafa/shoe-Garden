...
class BBranchClaimReport extends StatefulWidget {
  const BBranchClaimReport({super.key});

  @override
  State<BBranchClaimReport> createState() => _BBranchClaimReportState();
}

class _BBranchClaimReportState extends State<BBranchClaimReport> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Branch Claim Report"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
                    ...
                    case Status.COMPLETE:
                      return ListView.builder(
                        itemCount: controller
                            .branchClaimList.value.body!.claims!.length,
                        itemBuilder: (context, index) {
                          var data = controller
                              .branchClaimList.value.body!.claims![index];
