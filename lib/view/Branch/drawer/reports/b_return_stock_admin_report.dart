...
import '../product/widget/view_return_stock.dart';

class BReturnProductToAdminReport extends StatefulWidget {
  const BReturnProductToAdminReport({super.key});

  @override
  State<BReturnProductToAdminReport> createState() =>
      _BReturnProductToAdminReportState();
}

class _BReturnProductToAdminReportState
    extends State<BReturnProductToAdminReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Return Stock to Admin Report"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
