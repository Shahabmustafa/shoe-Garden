...
class BReturnStockWarehouseReport extends StatefulWidget {
  const BReturnStockWarehouseReport({super.key});

  @override
  State<BReturnStockWarehouseReport> createState() =>
      _BReturnStockWarehouseReportState();
}

class _BReturnStockWarehouseReportState
    extends State<BReturnStockWarehouseReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Return Stock to Warehouse Report"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
