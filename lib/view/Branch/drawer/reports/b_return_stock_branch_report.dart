...
class BReturnProductToBranchReport extends StatefulWidget {
  const BReturnProductToBranchReport({super.key});

  @override
  State<BReturnProductToBranchReport> createState() =>
      _BReturnProductToBranchReportState();
}

class _BReturnProductToBranchReportState
    extends State<BReturnProductToBranchReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Return Stock to Branch Report"),
      ),
      drawer: !isDesktop
          ? const SizedBox(
              width: 250,
