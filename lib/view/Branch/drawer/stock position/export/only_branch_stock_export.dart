...
class MyBranchStockExport {
  ...
  Future<Uint8List> generatePdf() async {
    ...
    for (int i = 0; i < controller.myBranchStockList.value.body!.branchStocks!.length; i++) {
      final stock = controller.myBranchStockList.value.body!.branchStocks![i];
      rows.add([
        "${i + 1}",
              ...
              children: [
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Text(controller.myBranchStockList.value.body?.sumOfQuantity.toString() ?? "0"),
                    pw.Text("Total Item Sale Price"),
                    pw.Text(controller.myBranchStockList.value.body?.sumOfSalePrice.toString() ?? "0"),
                  ],
                ),
