...
class AddBranchClaim extends StatelessWidget {
  const AddBranchClaim({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return FloatingActionButton.extended(
          ...
          builder: (context) {
            ...
            return StatefulBuilder(
              builder: (context, setState) {
                return AlertDialog(
                  title: const Text("Add Branch Claim"),
      ...
      label: const Text("Add Branch Claim"),
    );
  }
}
