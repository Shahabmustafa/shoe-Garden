...
class AddWarehouseClaim extends StatelessWidget {
  const AddWarehouseClaim({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return FloatingActionButton.extended(
          ...
          builder: (context) {
            ...
            return StatefulBuilder(
              builder: (context, setState) {
                return AlertDialog(
                  title: const Text("Add Warehouse Claim"),
      ...
      label: const Text("Add Warehouse Claim"),
    );
  }
}
