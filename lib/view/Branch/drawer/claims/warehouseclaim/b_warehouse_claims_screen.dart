...
import 'package:sofi_shoes/view/Branch/drawer/claims/warehouseclaim/add_warehouse_claim.dart';
...
import '../../../../../viewmodel/branch/claim/warehouse_claim_view_model.dart';
import '../../../../Manager/drawer/dashboard/dashboard_screen_a.dart';
import '../export/warehouse_claim_export.dart';

class BWarehouseClaim extends StatefulWidget {
  const BWarehouseClaim({super.key});

  @override
  State<BWarehouseClaim> createState() => _BWarehouseClaimState();
}

class _BWarehouseClaimState extends State<BWarehouseClaim> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  child: Obx(() {
                    switch (controller.rxRequestStatus.value) {
                      ...
                      case Status.COMPLETE:
                        var claims = controller.warehouseClaimList.value.body!.claims!;
                        ...
                        // If there are no matching claims after filtering
      ...
      floatingActionButton: const AddWarehouseClaim(),
    );
  }
}
