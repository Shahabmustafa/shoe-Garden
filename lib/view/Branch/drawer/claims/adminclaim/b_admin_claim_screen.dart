...
import 'package:sofi_shoes/view/Branch/drawer/claims/adminclaim/add_admin_claim.dart';
...
import '../export/admin_claim_export.dart';
import '../view_warehouse_claim.dart';

class BAdminClaim extends StatefulWidget {
  const BAdminClaim({super.key});

  @override
  State<BAdminClaim> createState() => _BAdminClaimState();
}

class _BAdminClaimState extends State<BAdminClaim> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: const AddAdminClaim(),
    );
  }
}
