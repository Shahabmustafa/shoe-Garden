...
import 'package:sofi_shoes/view/Branch/drawer/product/export/return_product_admin_export.dart';
import 'package:sofi_shoes/view/Branch/drawer/product/widget/view_return_stock.dart';
...
import 'widget/add_admin_product_return.dart';

class BReturnProductToAdminScreen extends StatefulWidget {
  const BReturnProductToAdminScreen({super.key});

  @override
  State<BReturnProductToAdminScreen> createState() =>
      _BReturnProductToAdminScreenState();
}

class _BReturnProductToAdminScreenState
    extends State<BReturnProductToAdminScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    children: [
                      ...
                      Flexible(
                        child: AppExportButton(
                          icons: Icons.add,
                          onTap: () {
                            ReturnProductAdminExport().printReturnProductPdf();
                          },
                        ),
                      )
                    ],
                  ...
                  child: Obx(() {
                    switch (controller.rxRequestStatus.value) {
                      ...
                      // Get the list of return products
                        var returnProducts = controller.returnProductToAdminList.value.body!.returnProducts!;
                                ...
                                children: [
                                  TableRow(
                                    ...
                                    children: [
                                      ...
                                      CustomTableCell(
                                        text: data.returnTo == null ? "Null" : data.returnTo!.name.toString(),
                                        textColor: Colors.black,
                                      ),
                                      CustomTableCell(
                                          ...
                                          showDialog(
                                            ...
                                            builder: (context) {
                                              return ViewReturnProduct(
                                                title: 'Return Product To Admin Detail',
                                                ...
                                                description: data.description == null ? "Null" : data.description!.toString(),
      ...
      floatingActionButton: AddAdminProductReturn(),
    );
  }
}
