...
class AddWarehouseProductReturn extends StatelessWidget {
  const AddWarehouseProductReturn({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return FloatingActionButton.extended(
          ...
          builder: (context) {
            ...
            return StatefulBuilder(
              builder: (context, setState) {
                return AlertDialog(
                  title: const Text("Add Return Stock to Warehouse"),
                          ...
                          return AppDropDown(
                            ...
                            onChanged: (productName) async {
                              ...
                              if (selectedProduct != null) {
                                ...
                                print(controller.selectWarehouse.value);
                                setState(() {
      ...
      label: const Text("Add Return Stock To Warehouse"),
    );
  }
}
