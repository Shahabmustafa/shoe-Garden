class ReturnedItemPurchaseInvoiceModel {
  bool? success;
  Null error;
  Body? body;

  ReturnedItemPurchaseInvoiceModel({this.success, this.error, this.body});

  ReturnedItemPurchaseInvoiceModel.fromJson(Map<String, dynamic> json) {
