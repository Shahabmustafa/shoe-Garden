class BAssignStockToOtherBranchModel {
  bool? success;
  Null error;
  Body? body;

  BAssignStockToOtherBranchModel({this.success, this.error, this.body});

  BAssignStockToOtherBranchModel.fromJson(Map<String, dynamic> json) {
...
class Body {
  ...
  Body({this.branchStocks, this.sumOfSalePrice, this.sumOfPurchasePrice});
