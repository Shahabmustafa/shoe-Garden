class AssignStockToMyBranchModel {
  bool? success;
  Null? error;
  Body? body;

  AssignStockToMyBranchModel({this.success, this.error, this.body});

  AssignStockToMyBranchModel.fromJson(Map<String, dynamic> json) {
