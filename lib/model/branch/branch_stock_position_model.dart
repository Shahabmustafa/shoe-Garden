class BBranchStockModel {
  bool? success;
  Null error;
  Body? body;

  BBranchStockModel({this.success, this.error, this.body});

  BBranchStockModel.fromJson(Map<String, dynamic> json) {
...
class Body {
  ...
  Body({this.branchStocks, this.sumOfSalePrice, this.sumOfPurchasePrice, this.sumOfQuantity});
