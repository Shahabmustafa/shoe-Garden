class ReturnedItemSaleInvoiceModel {
  bool? success;
  Null error;
  Body? body;

  ReturnedItemSaleInvoiceModel({this.success, this.error, this.body});

  ReturnedItemSaleInvoiceModel.fromJson(Map<String, dynamic> json) {
...
class Body {
  ...
  Body({this.saleReturn});

  Body.fromJson(Map<String, dynamic> json) {
    saleReturn = json['sale_return'] != null
        ? new SaleReturn.fromJson(json['sale_return'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.saleReturn != null) {
      data['sale_return'] = this.saleReturn!.toJson();
    }
    return data;
  }
}
