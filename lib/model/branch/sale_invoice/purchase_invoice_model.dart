...
class PurchaseInvoiceSearchModel {
  bool? success;
  Null error;
  Body? body;

  PurchaseInvoiceSearchModel({this.success, this.error, this.body});

  PurchaseInvoiceSearchModel.fromJson(Map<String, dynamic> json) {
