class SaleInvoiceModels {
  bool? success;
  Null? error;
  Body? body;

  SaleInvoiceModels({this.success, this.error, this.body});

  SaleInvoiceModels.fromJson(Map<String, dynamic> json) {
...
class Body {
  ...
  Body({this.invoice,this.totalSale,this.totalQuantity});
