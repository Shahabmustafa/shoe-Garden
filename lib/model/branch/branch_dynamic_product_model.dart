...
class BranchSearchDynamicProductModel {
  bool? success;
  Null error;
  Body? body;

  BranchSearchDynamicProductModel({this.success, this.error, this.body});

  BranchSearchDynamicProductModel.fromJson(Map<String, dynamic> json) {
