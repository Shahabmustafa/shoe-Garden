class BReturnProductToBranchModel {
  bool? success;
  Null error;
  Body? body;

  BReturnProductToBranchModel({this.success, this.error, this.body});

  BReturnProductToBranchModel.fromJson(Map<String, dynamic> json) {
