class BReturnProductToAdminModel {
  bool? success;
  Null error;
  Body? body;

  BReturnProductToAdminModel({this.success, this.error, this.body});

  BReturnProductToAdminModel.fromJson(Map<String, dynamic> json) {
