class BReturnProductToWareHouseModel {
  bool? success;
  Null error;
  Body? body;

  BReturnProductToWareHouseModel({this.success, this.error, this.body});

  BReturnProductToWareHouseModel.fromJson(Map<String, dynamic> json) {
