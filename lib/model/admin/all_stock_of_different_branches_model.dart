class AllStockOfDifferentBranchesModel {
  bool? success;
  Null error;
  Body? body;

  AllStockOfDifferentBranchesModel({this.success, this.error, this.body});

  AllStockOfDifferentBranchesModel.fromJson(Map<String, dynamic> json) {
