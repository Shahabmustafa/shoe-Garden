class SpecificBranchStockPositionModel {
  bool? success;
  Null? error;
  Body? body;

  SpecificBranchStockPositionModel({this.success, this.error, this.body});

  SpecificBranchStockPositionModel.fromJson(Map<String, dynamic> json) {
