class AAssignStockTwoWarehouseModel {
  bool? success;
  Null? error;
  Body? body;

  AAssignStockTwoWarehouseModel({this.success, this.error, this.body});

  AAssignStockTwoWarehouseModel.fromJson(Map<String, dynamic> json) {
