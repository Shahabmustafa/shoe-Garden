class ABranchClaimModel {
  bool? success;
  Null error;
  Body? body;

  ABranchClaimModel({this.success, this.error, this.body});

  ABranchClaimModel.fromJson(Map<String, dynamic> json) {
...
class Body {
  List<ClaimsFromBranches>? claimsFromBranches;

  Body({this.claimsFromBranches});

  Body.fromJson(Map<String, dynamic> json) {
    if (json['claims_from_branches'] != null) {
      claimsFromBranches = <ClaimsFromBranches>[];
      json['claims_from_branches'].forEach((v) {
        claimsFromBranches!.add(new ClaimsFromBranches.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.claimsFromBranches != null) {
      data['claims_from_branches'] =
          this.claimsFromBranches!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class ClaimsFromBranches {
  int? id;
  int? claimFromId;
  int? claimToId;
  int? companyId;
  ...
  ClaimsFromBranches.fromJson(Map<String, dynamic> json) {
    id = json['id'];
