class AReturnedStockWarehouseModel {
  bool? success;
  Null error;
  Body? body;

  AReturnedStockWarehouseModel({this.success, this.error, this.body});

  AReturnedStockWarehouseModel.fromJson(Map<String, dynamic> json) {
