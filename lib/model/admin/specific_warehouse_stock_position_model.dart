class SpecificWarehouseStockPositionModel {
  bool? success;
  Null? error;
  Body? body;

  SpecificWarehouseStockPositionModel({this.success, this.error, this.body});

  SpecificWarehouseStockPositionModel.fromJson(Map<String, dynamic> json) {
...
class Body {
  ...
  Body.fromJson(Map<String, dynamic> json) {
    if (json['warehouse_stock'] != null) {
      ...
      json['warehouse_stock'].forEach((v) {
        warehouseStock!.add(new WarehouseStock.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.warehouseStock != null) {
      data['warehouse_stock'] =
          this.warehouseStock!.map((v) => v.toJson()).toList();
    }
...
class WarehouseStock {
  ...
  WarehouseStock.fromJson(Map<String, dynamic> json) {
    ...
    approvedByWarehouse = json['approved_by_warehouse'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['approved_by_warehouse'] = this.approvedByWarehouse;
