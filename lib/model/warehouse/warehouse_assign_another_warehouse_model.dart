class WAssignToAnotherWarehouseModel {
  bool? success;
  Null error;
  Body? body;

  WAssignToAnotherWarehouseModel({this.success, this.error, this.body});

  WAssignToAnotherWarehouseModel.fromJson(Map<String, dynamic> json) {
