class PurchaseInvoiceModel {
  ...
  PurchaseInvoiceModel({this.success, this.error, this.body});
...
class Body {
  ...
  Body({this.purchaseInvoices});

  Body.fromJson(Map<String, dynamic> json) {
    if (json['purchase_invoices'] != null) {
      purchaseInvoices = <PurchaseInvoices>[];
      json['purchase_invoices'].forEach((v) {
        purchaseInvoices!.add(new PurchaseInvoices.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.purchaseInvoices != null) {
      data['purchase_invoices'] =
          this.purchaseInvoices!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class PurchaseInvoices {
  ...
  PurchaseInvoices.fromJson(Map<String, dynamic> json) {
    id = json['id'];
