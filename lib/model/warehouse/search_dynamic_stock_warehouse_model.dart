...
class SearchDynamicStockWarehouseModel {
  bool? success;
  Null error;
  Body? body;

  SearchDynamicStockWarehouseModel({this.success, this.error, this.body});

  SearchDynamicStockWarehouseModel.fromJson(Map<String, dynamic> json) {
