class WarehouseSaleReturnInvoiceModel {
  bool? success;
  Null error;
  Body? body;

  WarehouseSaleReturnInvoiceModel({this.success, this.error, this.body});

  WarehouseSaleReturnInvoiceModel.fromJson(Map<String, dynamic> json) {
