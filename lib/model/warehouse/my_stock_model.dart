class WMyStockModel {
  ...
  WMyStockModel({this.success, this.error, this.body});

  WMyStockModel.fromJson(Map<String, dynamic> json) {
...
class Body {
  ...
  Body({this.warehouseStocks, this.sumOfSalePrice, this.sumOfPurchasePrice,this.sumOfQuantity});
