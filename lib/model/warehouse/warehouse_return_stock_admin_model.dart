class WReturnedStockToAdminModel {
  bool? success;
  Null error;
  Body? body;

  WReturnedStockToAdminModel({this.success, this.error, this.body});

  WReturnedStockToAdminModel.fromJson(Map<String, dynamic> json) {
