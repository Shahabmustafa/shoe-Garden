...
import 'package:sofi_shoes/model/admin/return_stock_warehouse_model.dart';

import '../../../date/repository/admin/status/status_rep.dart';
import '../../../date/response/status.dart';
import '../../../res/utils/utils.dart';

class ReturnedStockWarehouseViewModel extends GetxController {
  ...
  final returnedStockWarehouseList = AReturnedStockWarehouseModel().obs;

  RxString error = ''.obs;

  void setRxRequestStatus(Status value) => rxRequestStatus.value = value;
  void setReturendStockWarehouse(AReturnedStockWarehouseModel value) =>
      returnedStockWarehouseList.value = value;
  ...
  void getAllReturnedStockWarehouse() {
    setRxRequestStatus(Status.LOADING);

    _api.getAllReturnedStockWarehouse().then((value) {
      setRxRequestStatus(Status.COMPLETE);
      clear();
      setReturendStockWarehouse(value);
