...
import '../../../date/repository/warehouse/Assign Stock/returned_stock_to_admin_repo.dart';
import '../../../date/repository/warehouse/Assign Stock/search_dynamic_assign_rep.dart';
import '../../../date/response/status.dart';
import '../../../res/utils/utils.dart';

class WReturnedStockToAdminViewModle extends GetxController {
  ...
  /// repository
  final _api = WReturnedStockToAdminRepository();
    ...
    try {
      ...
      _api.add(data).then((value) {
        ...
        if (value['success'] == true && value['error'] == null) {
          ...
          Get.back();
          clearDropdown();
          Utils.SuccessToastMessage('Add Returned Stock to Admin');
        } else {
