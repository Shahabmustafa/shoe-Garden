...
import '../../../date/repository/warehouse/Assign Stock/returned_stock_from_another_warehouse_repo.dart';
import '../../../date/response/status.dart';
import '../../../model/warehouse/warehouse_return_stock_admin_model.dart';

class WReturnedStockFromWarehouseViewModel extends GetxController {
  final search = TextEditingController().obs;

  /// repository
  final _api = WReturnedStockFromAnotherWarehouseRepository();
