...
import 'package:sofi_shoes/date/repository/branch/claim/admin_claim_repository.dart';
...
import '../../../date/repository/branch/stockposition/b_only_my_branch_stock_repository.dart';
import '../../../res/utils/utils.dart';

class BAdminClaimViewModel extends GetxController {
  ...
  final _api = BAdminClaimRepository();
  final _productApi = BOnlyMyBranchStockRepository();
  final _searchApi = BranchSearchDynamicProductRepository();
  final rxRequestStatus = Status.LOADING.obs;
  final adminClaimList = BAdminClaimModel().obs;
  RxString error = ''.obs;

  void setRxRequestStatus(Status value) => rxRequestStatus.value = value;
  void setBranchClaimList(BAdminClaimModel value) =>
      adminClaimList.value = value;
