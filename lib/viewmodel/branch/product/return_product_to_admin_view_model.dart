...
import '../../../date/repository/branch/product/return_product_to_admin_repository.dart';
import '../../../model/branch/product/return_product_to_admin_model.dart';

class BReturnProductToAdminViewModel extends GetxController {
  ...
  final _api = BReturnProductToAdminRepository();
  final searchApi = BranchSearchDynamicProductRepository();

  final rxRequestStatus = Status.LOADING.obs;
  final returnProductToAdminList = BReturnProductToAdminModel().obs;
  RxString error = ''.obs;

  void setRxRequestStatus(Status value) => rxRequestStatus.value = value;
  void setReturnProductToAdminList(BReturnProductToAdminModel value) =>
      returnProductToAdminList.value = value;
  ...
  void getAll() {
    ...
    _api.getAll().then((value) {
      ...
      setReturnProductToAdminList(value);
    ...
    try {
      ...
      _api.add(data).then((value) {
        ...
        if (value['success'] == true && value['error'] == null) {
          getAll();
          Get.back();
          Utils.SuccessToastMessage('Successfully Return Product To Admin');
        } else {
